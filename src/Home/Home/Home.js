...
const Home = () => {
    return (
        <div className="main-container">
            ...
            <Container className='container'>
                ...
                <Box className='header-section' sx={{ display: 'flex', justifyContent: 'center', mt: { md: '100px' } }}>
                    <Box className="header-container" sx={{ borderRadius: '20px', p: 10, width: { xs: '100%', md: '900px' } }}>
                        ...
                        <Typography className='join-us font-style' sx={{ color: 'white', mr: '20px', fontSize: "70px" }} variant="h3">JOIN US TODAY</Typography>
                ...
                <Box sx={{ mb: 10, p: 10, borderRadius: '20px', }} className="another-container">
                    ...
                    <Grid container spacing={3}>
                        <Grid md={4} item>
                            ...
                            <Box>
                                <Typography className="des wallet font-style" sx={{ typography: { md: 'h4' }, color: 'white', textAlign: 'center', mb: 3 }}>Connect Wallet</Typography>

                                <Typography className="des how-to font-style" sx={{ typography: { md: 'h6' }, color: 'white', mb: 3 }}>1. Install Phantom  (<a style={{ color: 'white', textDecoration: 'none' }} href="https://phantom.app/">https://phantom.app/</a>) wallet</Typography>

                                <Typography className="des how-to font-style" sx={{ typography: { md: 'h6' }, color: 'white', mb: 3 }}>2. Transfer SOL to your wallet</Typography>

                                <Typography className="des how-to font-style" sx={{ typography: { md: 'h6' }, color: 'white' }}>3. Connect wallet</Typography>
                        ...
                        <Grid md={4} item>
                            ...
                            <Box>
                                <Typography className="des wallet font-style" sx={{ typography: { md: 'h4' }, color: 'white', textAlign: 'center', mb: 3 }}>Mint SoLotto</Typography>

                                <Typography className="des how-to font-style" sx={{ typography: { md: 'h6' }, color: 'white', mb: 3 }}>1. Select the amount of NFT (s) you wish to purchase and click MINT</Typography>

                                <Typography className="des how-to font-style" sx={{ typography: { md: 'h6' }, color: 'white', mb: 3 }}>2. Click "Approve" on the popup (gas fee and other fees will be applied at your expenses)</Typography>

                                <Typography className="des how-to font-style" sx={{ typography: { md: 'h6' }, color: 'white' }}>3. Then you will see the NFT (s) , in your wallet after a period of time</Typography>
                        ...
                        <Grid md={4} item>
                            ...
                            <Box>
                                <Typography className="des wallet font-style" sx={{ typography: { md: 'h4' }, color: 'white', textAlign: 'center', mb: 3 }}>Win SoLotto</Typography>

                                <Typography className="des how-to font-style" sx={{ typography: { md: 'h6' }, color: 'white', mb: 3 }}>1. Wait for the announcement</Typography>

                                <Typography className="des how-to font-style" sx={{ typography: { md: 'h6' }, color: 'white', mb: 3 }}>2. You will receive a message if you win through Wallet Chat</Typography>
                ...
                <Box>
                    <Grid container spacing={3}>
                        ...
                        <Grid md={6} item>
                            ...
                            <Typography className="des solona font-style" sx={{ color: 'white', fontWeight: 600, mt: 3 }} variant="h5">2 SOL(SOLANA) per Unit.</Typography>
                        </Grid>
                    </Grid>
                </Box>
                ...
                <Box sx={{ mt: '100px', mb: '100px' }}>
                    ...
                    <Typography className="des units font-style" sx={{ color: 'white', fontWeight: 600, mt: 3 }} variant="h5">
                ...
                <Box sx={{ mb: '100px' }}>
                    ...
                    <Typography className="des units font-style" sx={{ color: 'white', fontWeight: 600, mt: 3, textAlign: 'end' }} variant="h5">5,000 units per event <br /> ※If 5,000 units are sold early, the second event will then be sold.</Typography>
                </Box>
                ...
                <Box sx={{ pb: { md: '100px' } }}>
                    <Grid container spacing={2}>
                        <Grid md={6} item>
                            ...
                            <Typography className="des units font-style" sx={{ color: 'white', fontWeight: 600, mt: 3 }} variant="h5">PRICE: 2SOL($282.26)</Typography>
                            <Typography className="des units font-style" sx={{ color: 'white', fontWeight: 600, mt: 3 }} variant="h5">1 SoLotto: US$289.76 worth of Solana (current rate of 2 SOL)</Typography>
                            <Typography className="des units font-style" sx={{ color: 'white', fontWeight: 600, mt: 3 }} variant="h5">SOL Price: live by <a style={{ color: 'white', textDecoration: 'none' }} href="https://binance.com">binance.com</a></Typography>
                        </Grid>
                    ...
                    <Box className="another-container prizemoney" sx={{ width: '100%', borderRadius: '20px', p: 5 }}>
                        ...
                        <Grid sx={{ mb: 10 }} spacing={1} container>
                            <Grid md={4} item>
                                ...
                                <Typography className="des units font-style" sx={{ color: 'white', mt: 3 }} variant="h5">6,670SOL ($0.94Million) ×1</Typography>

                            </Grid>
                            <Grid md={4} item>
                                <Typography className="soloto second units" sx={{ color: 'yellow' }} variant="h4">2ND PRIZE</Typography>
                                <Typography className="des units font-style" sx={{ color: 'white', fontWeight: 600, mt: 3 }} variant="h5">66.7SOL ($9,413.37) ×9</Typography>

                            </Grid>
                            <Grid md={4} item>
                                <Typography className="soloto second units" sx={{ color: 'yellow' }} variant="h4">3RD PRIZE</Typography>
                                <Typography className="des units font-style" sx={{ color: 'white', fontWeight: 600, mt: 3 }} variant="h5">4SOL ($564.52) × 200</Typography>
                        ...
                        <Grid direction="row-reverse" spacing={2} sx={{ mb: 10 }} container>
                            <Grid md={4} item>
                                ...
                                <Typography className="des units font-style" sx={{ color: 'white', fontWeight: 600, mt: 3 }} variant="h5">66.7SOL ×1</Typography>
                            </Grid>
                            <Grid md={4} item>
            ...
            <footer>
                <Typography className='font-style' sx={{ color: 'white', fontWeight: 600, textAlign: 'center', pb: 3 }} variant="h5">©2021 SOLOTTO. All rights reserved.</Typography>
            </footer>
